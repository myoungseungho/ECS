...
cl /nologo /std:c++17 /EHsc /c /I"%SRC%" "%SRC%Core\World.cpp" /Fo"%OUT%\World.obj"
if errorlevel 1 exit /b 1

echo [2/5] NetworkEngine\IOCPServer.cpp
cl /nologo /std:c++17 /EHsc /c /I"%SRC%" "%SRC%NetworkEngine\IOCPServer.cpp" /Fo"%OUT%\IOCPServer.obj"
if errorlevel 1 exit /b 1

echo [3/5] NetworkEngine\Session.cpp
cl /nologo /std:c++17 /EHsc /c /I"%SRC%" "%SRC%NetworkEngine\Session.cpp" /Fo"%OUT%\Session.obj"
if errorlevel 1 exit /b 1

echo [4/5] Systems\NetworkSystem.cpp
cl /nologo /std:c++17 /EHsc /c /I"%SRC%" "%SRC%Systems\NetworkSystem.cpp" /Fo"%OUT%\NetworkSystem.obj"
if errorlevel 1 exit /b 1

echo [5/5] Servers\FieldServer\main.cpp
cl /nologo /std:c++17 /EHsc /c /I"%SRC%" "%SRC%Servers\FieldServer\main.cpp" /Fo"%OUT%\main.obj"
if errorlevel 1 exit /b 1
